...
/>
              <label htmlFor="avatar-upload"className={`absolute bottom-0 right-0 bg-base-content hover:scale-105 p-2 rounded-full cursor-pointer transition-all duratin-200 ${isUpdatingProfile ? "animate-pulse pointer-events-none":""}`}>
